  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-14 space-y-10">
        <div>
          <p className="text-xs font-black tracking-widest uppercase text-[#AAFF00] mb-1">Legal</p>
          <h1 className="text-3xl font-black text-white">Privacy Policy</h1>
          <p className="mt-3 text-sm text-[#6A6A6A]">Last updated: 14 Jun 2026</p>
        </div>

        <section className="space-y-4 text-sm text-[#A3A3A3] leading-7">
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">1. What we collect</h2>
          <ul className="space-y-2 text-sm text-[#A3A3A3] leading-7 list-disc list-inside">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">2. Legal bases for processing</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">3. How we use it</h2>
          <ul className="space-y-2 text-sm text-[#A3A3A3] leading-7 list-disc list-inside">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">4. Who we share it with</h2>
          <ul className="space-y-2 text-sm text-[#A3A3A3] leading-7 list-disc list-inside">
            <li><strong>Dodo Payments</strong> &mdash; payment processing and subscription management. Dodo Payments is Merchant of Record for all transactions and has its own <a href="https://dodopayments.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 hover:text-[#AAFF00] transition-colors">privacy policy</a>. Data is processed under Standard Contractual Clauses.</li>
          ...
          <p className="text-sm text-[#A3A3A3] leading-7">We do not sell your data. We do not share it with advertisers.</p>
        </section>

        <section className="space-y-3">
          <h2 className="text-base font-black text-white">5. Data retention</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">We keep different categories of data for different periods:</p>
          <ul className="space-y-2 text-sm text-[#A3A3A3] leading-7 list-disc list-inside">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">6. Account deletion</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
            You can delete your account at any time from your{" "}
            <a href="/profile" className="underline underline-offset-2 hover:text-[#AAFF00] transition-colors">Profile page</a>.
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">7. Your rights</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">8. Supervisory authority</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
            ...
            <a href="https://ico.org.uk/make-a-complaint/" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 hover:text-[#AAFF00] transition-colors">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">9. Cookies</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">We use two categories of cookies:</p>
          <ul className="space-y-2 text-sm text-[#A3A3A3] leading-7 list-disc list-inside">
            <li><strong>Strictly necessary</strong> &mdash; session authentication (Supabase) and free-view count tracking (<code className="text-xs bg-[#1A1A1A] px-1 py-0.5 rounded">ec_views</code>). These cannot be declined as the service will not function without them.</li>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">10. Automated decision-making and profiling</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">11. Changes to this policy</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">12. Contact</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
