    ...
    >
      ...
      {isUnlocked && (
        <div className="mt-10 pt-10 border-t border-[#2A2A2A]">
          <p className="text-xs font-black tracking-widest uppercase text-[#AAFF00] mb-2">Arranging accessible attendance</p>
          <p className="text-sm text-[#A3A3A3] leading-7">
            If you need reduced-mobility ticketing or seating, contact the circuit directly via WhatsApp
            (+971 800 927) well ahead of your visit rather than assuming standard ticket purchase automatically
            accounts for accessibility needs — this ensures reserved seating and any special arrangements are
            genuinely in place before you arrive, not sorted on the day.
          </p>
        </div>
      )}
    </SpokeShell>
