...
export const SPOKE_METADATA: Record<string, Record<string, string>> = {
  ...
  "brazilian-grand-prix": {
    cost: "How Much Does the São Paulo Grand Prix Cost? — São Paulo Budget Guide",
    tickets: "Interlagos Ticket Guide — No General Admission, Grandstand by Grandstand",
    hotels: "Where to Stay for the São Paulo Grand Prix — Jardins, Morumbi, or Self-Catered",
    "getting-there": "Getting to Interlagos — São Paulo Grand Prix Transit Guide",
    weather: "São Paulo Weather in November — What to Pack for the São Paulo Grand Prix",
    "first-timer-guide": "First-Timer's Guide — the São Paulo Grand Prix",
    "where-to-eat": "Where to Eat in São Paulo — São Paulo Grand Prix Weekend",
    "day-trips": "Best Day Trips and Sightseeing — São Paulo Grand Prix Weekend",
    itinerary: "Sample São Paulo Grand Prix Weekend Itinerary",
