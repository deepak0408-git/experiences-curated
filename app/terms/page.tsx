  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A]">
      ...
      <div className="max-w-3xl mx-auto px-6 py-14 space-y-10">
        <div>
          <p className="text-xs font-semibold tracking-widest uppercase text-[#AAFF00] mb-1">Legal</p>
        ...
        <section className="space-y-4 text-sm text-[#A3A3A3] leading-7">
          <p>
            By using Experiences | Curated (&ldquo;the Service&rdquo;), you agree to these terms. If you don&apos;t agree, please don&apos;t use the Service. These terms, together with our <Link href="/privacy" className="underline underline-offset-2 hover:text-[#AAFF00] transition-colors">Privacy Policy</Link>, form a binding agreement between you and us, governed by the laws of India including the Information Technology Act 2000 and the Digital Personal Data Protection Act 2023 (DPDPA).
          </p>
        </section>

        <section className="space-y-3">
          <h2 className="text-base font-black text-white">1. What the Service is</h2>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">2. Accounts and eligibility</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">3. Event packs and purchases</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">4. Pro subscription</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">5. Content accuracy and assumption of risk</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">6. User-generated content</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">7. Acceptable use</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">You must not:</p>
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">8. Intellectual property</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">9. Disclaimer of warranties</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">10. Limitation of liability</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">11. Indemnification</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">12. Force majeure</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">13. Governing law and jurisdiction</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">14. Changes to these terms</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
        ...
        <section className="space-y-3">
          <h2 className="text-base font-black text-white">15. Contact</h2>
          <p className="text-sm text-[#A3A3A3] leading-7">
