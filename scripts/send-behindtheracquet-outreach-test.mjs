...
// TEST COPY ONLY -- sends to the founder's own inbox for visual check before
// the real send to zach@behindtheracquet.com, per the standing CLAUDE.md rule:
// "never send a new outreach email without first sending a test copy to the
// founder's own inbox for a visual check."
