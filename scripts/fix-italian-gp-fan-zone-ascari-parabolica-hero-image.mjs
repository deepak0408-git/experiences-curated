...
const SLUG = "the-fan-zone-ascari-to-parabolica-mrbp88aj";
const LOCAL_PATH = "Images/Italian GP - Fan Zone Ank Kumar CC BY 4.0.jpg";
const R2_KEY = "experiences/hero/the-fan-zone-ascari-to-parabolica.jpg";
