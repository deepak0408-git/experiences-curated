...
// Hero image update, batch 8 of Qatar GP 2026 experiences.
// Curator-confirmed pick, 13 Sep 2026. Source independently verified by curator.
const UPDATES = [
  {
    id: "c84fa5f9-4e60-4eb4-ab42-b8f03ceddae5",
    title: "Lusail Hill Lounge",
    localFile: "Images/Qatar GP - Lounge credit Jpatokal CC BY 4.0.jpg",
    imageKey: "experiences/hero/qatar-gp-lusail-hill-lounge.jpg",
    alt: "Elevated lounge viewing area at Lusail Hill",
    credit: "Jpatokal / CC BY 4.0",
  },
];
