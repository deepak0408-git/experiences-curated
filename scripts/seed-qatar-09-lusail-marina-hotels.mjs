...
Raffles occupies the upper floors as an all-suite property: 132 suites, no standard rooms, each with a personal butler and floor-to-ceiling windows looking out over either the sea or the city skyline. It's ranked #2 of 12 hotels in Lusail on TripAdvisor, and its Google rating backs that up at a genuinely strong 4.6 from 1,848 reviews — guests consistently single out the suite layouts and the views as the standout. [See live rating and reviews on Google Maps](https://maps.google.com/?cid=15484831753459197357&g_mp=Cidnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLlNlYXJjaFRleHQQAhgEIAA)

Fairmont Doha shares the same building and marina address but runs as its own distinct property beneath Raffles, with its own entrance, service, and room stock — a more conventional five-star hotel experience rather than the all-suite format above it. Reviews consistently mention immaculate housekeeping and the same striking Arabian Gulf views the location affords. Fairmont's Google rating sits at 4.5 from 3,238 reviews, a genuinely large sample backing a strong score. [See live rating and reviews on Google Maps](https://maps.google.com/?cid=17948980481003576429&g_mp=Cidnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLlNlYXJjaFRleHQQAhgEIAA)
