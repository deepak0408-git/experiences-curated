...
const SLUG = "italian-gp-grandstand-1-centrale-mu7cn5ry";
const LOCAL_PATH = "Images/Italian GP - Grandstand 1.jpg";
const R2_KEY = "experiences/hero/italian-gp-grandstand-1-centrale.jpg";
