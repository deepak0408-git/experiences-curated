...
// Replaces the existing Brabham Grandstand hero image with a real, licensed
// photo — CC BY 4.0 (Yu Chu Chin), 20 Sep 2026.
const SLUG = "brabham-grandstand-turns-1-2-mu9c1dch";
const localFile = "Images/Australian GP - Brabham Grandstand Yu Chu Chin CC BY 4.0.jpg";
const imageKey = "experiences/hero/brabham-grandstand-turns-1-2-mu9c1dch.jpg";
