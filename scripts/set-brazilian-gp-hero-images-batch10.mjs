...
const file = readFileSync("Images/Brazilian GP - Paddock.jpg");
const r2Key = "sporting-events/hero/brazilian-grand-prix-paddock-club.jpg";
...
const [row] = await db
  ...
  .set({
    heroImageUrl,
    heroImageAlt: "Paddock Club hospitality, Brazilian Grand Prix",
