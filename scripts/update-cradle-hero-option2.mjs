...
try {
  const imagePath = "Images/Sterkfontein Caves Interior.jpg";
  await download("https://upload.wikimedia.org/wikipedia/commons/a/a6/Sterkfontein_Caves_45.jpg", imagePath);
  console.log("✓ Downloaded Sterkfontein Caves interior image");
  ...
  const [result] = await db.update(experiences).set({
    heroImageUrl,
    heroImageAlt: "Interior of the Sterkfontein Caves, Cradle of Humankind",
