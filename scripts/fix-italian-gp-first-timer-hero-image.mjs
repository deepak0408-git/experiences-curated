...
const LOCAL_PATH = "Images/Italian GP - First Timer credit Cynthia Vallen.jpg";
const R2_KEY = "experiences/hero/italian-gp-first-timer-guide.jpg";
const CREDIT = "Cynthia Vallen";
