...
const SLUG_PREFIX = "monza-inside-the-venue-";
const LOCAL_PATH = "Images/Italian GP - Monza Start Line credit Gian Luca Sgaggero.jpg";
const R2_KEY = "experiences/hero/monza-inside-the-venue-v2.jpg";
const CREDIT = "Gian Luca Sgaggero, CC BY 2.0";
...
try {
  ...
  const [result] = await db
    ...
    .where(like(experiences.slug, `${SLUG_PREFIX}%`))
