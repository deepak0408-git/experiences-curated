...
const file = readFileSync("Images/Brazilian GP - Arrival geogast.jpg");
const r2Key = "sporting-events/hero/brazilian-grand-prix-arrival-queue.jpg";
...
const [row] = await db
  ...
  .set({
    heroImageUrl,
    heroImageAlt: "Arrival at Interlagos, Brazilian Grand Prix",
    heroImageCredit: "geogast",
  })
