...
const SLUG = "hotel-de-la-ville-monza-mqzdvzcf";
const LOCAL_PATH = "Images/Italian GP - Villa Monza credit Maria Stella Inzone.jpg";
const R2_KEY = "experiences/hero/hotel-de-la-ville-monza-v2.jpg";
const CREDIT = "Maria Stella Inzone";
