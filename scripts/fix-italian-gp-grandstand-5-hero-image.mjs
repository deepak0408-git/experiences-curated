...
const LOCAL_PATH = "Images/Italian GP Monza Contract - Clouds Over Monza Circuit.jpg";
const R2_KEY = "experiences/hero/italian-gp-grandstand-5-piscina.jpg";
const CREDIT = "Maksym Harbar";
