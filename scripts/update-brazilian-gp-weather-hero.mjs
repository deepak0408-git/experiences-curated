...
const file = readFileSync("Images/Brazilian GP - Weather.jpg");
const r2Key = "experiences/hero/brazilian-gp-weather-packing.jpg";
...
const [row] = await db
  ...
  .set({
    heroImageUrl,
    heroImageAlt: "Weather in São Paulo during Brazilian GP race weekend",
