...
// ─── 1. Download travel prep image from Unsplash and upload to R2 ────────────

const imageUrl = "https://images.unsplash.com/photo-1673505705715-8deb093d39e8?fm=jpg&q=80&w=3000&auto=format&fit=crop";
const imageKey = "experiences/hero/wimbledon-preparing.jpg";
...
console.log("✓ Travel prep hero image uploaded:", heroImageUrl);

// ─── 2. Updated content with bold headers ────────────────────────────────────
...
await db
  .update(experiences)
  .set({ bodyContent, heroImageUrl })
  .where(eq(experiences.id, EXPERIENCE_ID));

console.log("✓ Preparing experience headers bolded and hero image updated");
await client.end();
